...
if __name__ == '__main__':
    ...
    data_dict = data.prepare_data(batch_size=args.batch_size, num_workers=NUM_WORKERS, seed=SEED)
    ...
    # save model
    trainer.save_checkpoint(os.path.join(args.out_dir, f'{log_name}.ckpt'), weights_only=True)
